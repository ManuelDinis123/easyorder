            ...
            function createBarChart(chartID) {
                ...
                var data = {
                    ...
                    datasets: [{
                            ...
                            data: formatForBarChart(chartID == "profit_p_day" ? JSON.parse($("#barChartThis").val()) :
                                JSON.parse($("#barChartThisWEEK").val()))
                        },
                        {
                            label: chartID == "profit_p_day" ? "Ultima Semana" : (chartID == "profit_p_week" ?
                                "Ultimo Mês" : "Ultimo Ano"),
                            backgroundColor: "#5a76be",
                            data: formatForBarChart(chartID == "profit_p_day" ? JSON.parse($(
                                "#barChartLast").val()) : JSON.parse($("#barChartLastWEEK").val()))
                        }
                    ]
                };
